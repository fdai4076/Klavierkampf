...
namespace WindowsGame1
{
    public class CharacterManager
    {
        ...
        public CharacterManager(Model[] modelle)
        {
            ...
            klavier.speed = 0.04f;
            klavier.rotationSpeed = 0.02f;
            klavier.dashpower = 0.07f;
            klavier.dashCountdown = 10000;
            klavier.power = 0.10f;
            klavier.mass = 0.07f;
            ...
            kleiderschrank.speed = 0.080f;
            kleiderschrank.rotationSpeed = 0.04f;
            kleiderschrank.dashpower = 0.07f; 
            kleiderschrank.dashCountdown = 6000;
            kleiderschrank.power = 0.050f;
            ...
            sofa.speed = 0.05f;
            sofa.rotationSpeed = 0.025f;
            sofa.dashpower = 0.07f;
            ...
            kuehlschrank.rotationSpeed = 0.05f;
            kuehlschrank.dashpower = 0.07f;
            kuehlschrank.dashCountdown = 3500;
            kuehlschrank.power = 0.040f;
            kuehlschrank.mass = 0.03f;
